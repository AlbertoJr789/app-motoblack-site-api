...
<style>    
    #tableOngoingTrips_filter{
        display: none !important;
    }

    #tableOngoingTrips thead, #tableOngoingTrips tfoot {
        display: none !important;
    }
...
<template>
    <!-- <button class="btn-primary mx-2" onclick="" id="btnFilterOngoingTrips">
        <i class="fa-solid fa-magnifying-glass-chart mr-1"></i> Filtro
    </button> -->
    <DataTable :columns="columns" :ajax="ajax" :options="options" ref="table" class="display responsive border border-transparent border-separate border-spacing-0 rounded-lg" id="tableOngoingTrips">
...
<script setup>
    ...
    const options = {
        ...
        initComplete: function() {
            $("#tableOngoingTrips_wrapper").find('.toolbar').append($('#btnFilterOngoingTrips'));
        }
    };
