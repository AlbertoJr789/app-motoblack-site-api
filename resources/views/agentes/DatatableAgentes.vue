<template>
    ...
    <DataTable :columns="columns" :ajax="ajax" :options="options" ref="table" class="display responsive border border-transparent border-separate border-spacing-0 rounded-lg" id="tableAgentes">
...
<script setup>
    ...
    const columns = [
        ...
        {data: 'id', title: window.trans('id')},{data: 'tipo', title: window.trans('tipo')},{data: 'status', title: window.trans('status')},{data: 'latitude', title: window.trans('latitude')},{data: 'longitude', title: window.trans('longitude')},{data: 'created_at', title: window.trans('Creation Date')},{data: 'updated_at', title: window.trans('Update Date')},
    ...
    const options = {
        ...
        initComplete: () => {
            if(props.canDelete)
                handleCheckboxes(document.getElementById('tableAgentes'),checked)
        },
        drawCallback: () => {
            if(props.canDelete){
