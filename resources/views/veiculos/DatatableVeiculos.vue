...
<script setup>
    ...
    const columns = [
        ...
        {data: 'dono',name: "P.nome", title: window.trans('Owner')},
        {data: 'tipo', title: window.trans('Type')},
        {data: 'modelo', title: window.trans('Model')},
        {data: 'marca', title: window.trans('Brand')},
