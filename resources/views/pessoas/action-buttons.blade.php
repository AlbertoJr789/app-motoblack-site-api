<div class="flex justify-end">
    @if(!$data->deleted_at)
        @can('pessoas.edit')
        <button
            class="btn-secondary w-[25px] h-[25px] ms-auto me-1 flex justify-center" title="Editar Registro" onclick="Livewire.dispatch('openEdit',{ pessoa: {{$data->id}} })">
        ...
        @endcan
        @can('pessoas.delete')
            @if(!$data->agente && !$data->passageiro)
